...
rm .\Source\AccidentalFish.Commanding.Abstractions\bin\debug\*.nupkg
...
if ($pushLocal)
{
	cp .\Source\AccidentalFish.Commanding.Abstractions\bin\debug\*.nupkg \MicroserviceAnalyticPackageRepository
...
if ($pushNuget)
{
	dotnet nuget push .\Source\AccidentalFish.Commanding.Abstractions\bin\debug\*.nupkg --source nuget.org
